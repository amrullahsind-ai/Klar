# Edura V6.4 Stable Pilot Notes

Versi ini fokus ke stabilitas pilot, bukan penambahan fitur besar.

## Perubahan utama
- Branding tampilan menjadi **Edura** saja, tanpa label V6 pada landing page.
...
## Catatan batasan
Edura V6.4 masih cocok untuk pilot sekolah kecil-menengah dengan database Spreadsheet masing-masing sekolah. Untuk massal besar, tetap disarankan migrasi bertahap ke database proper seperti Supabase/PostgreSQL.
